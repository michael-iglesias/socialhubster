      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li>
              <a href="gallery.php">Create Social Hub</a>
            </li>
            <li>
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="controls">
            ...
            <span style="margin-bottom: 0px; padding-bottom: 0px; color: red; font-size: 12px; margin-top: 0px; display: none;" id="service-name-taken">Name Already Taken! Please choose another.</span>
          </div>
        </div>
        <div class="form-group">
